...
copyFarm name
  [
    {
      name = "datetime-0.0.1-6-va78-AQgA0_OvOrxeem7LnZqCmkjL3AkD9XeT81C4l";
      path = fetchZigArtifact {
        name = "datetime";
        url = "git+https://git.jcollie.dev/jeff/zig-datetime.git#b1d225e0548572c88c41a8b551b8397e5e168412";
